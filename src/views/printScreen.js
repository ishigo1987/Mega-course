module.exports = (formInfo)=>{
    ...
    new TextView({left:15,right:15,top:['prev()',15],text:`DATE:  ${formInfo.date}`,font:'15px roboto'}).appendTo(scrollView);
    new TextView({left:15,right:15,top:['prev()',15],text:`HEURE: ${formInfo.hour} h ${new Date().getMinutes()} min`,font:'15px roboto'}).appendTo(scrollView);
